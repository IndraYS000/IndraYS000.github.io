...
<html lang="en">
    ...
    <body>
        ...
        <form action="proses_edit.php" class="form" method="post" name="edit">
            ...
            <div class="container">
                <label for="oldusername"><b>Username Lama</b></label>
                 <input type="text" placeholder="Enter Username" name="oldusername" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"
				 title="Harus berisi format email yang valid" required>
                <label for="oldpassword"><b>Password Lama</b></label>
                 <input type="password" placeholder="Enter Password" name="oldpassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
				 title="Harus berisi setidaknya satu angka dan satu huruf besar dan kecil, dan setidaknya 8 karakter atau lebih"required>
                <label for="newusername"><b>Username Baru</b></label>
                 <input type="text" placeholder="Enter Username" name="newusername" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"
				 title="Harus berisi format email yang valid" required>
                <label for="newpassword"><b>Password Baru</b></label>
                 <input type="password" placeholder="Enter Password" name="newpassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
				 title="Harus berisi setidaknya satu angka dan satu huruf besar dan kecil, dan setidaknya 8 karakter atau lebih"required>
        ...
        <div class="modal-dialog" id="popup" role="document">
            ...
            <div class="modal-header">
                <h5 class="middle" id="ModalLongTitle">Login Telah Berhasil</h5>
                </button>
            </div>
